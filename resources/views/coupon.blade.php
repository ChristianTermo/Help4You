...
<body>
    ...
    <form method="POST" action="{{route('generate')}}">
        ...
        <div class="form-group">
            <label for="count">quanti coupon generare:</label>
            <input type="number" class="form-control" name="count" required>
        </div>

        <div class="form-group">
            <label for="discount">valore coupon:</label>
            <input type="number" class="form-control" name="discount" required>
        </div>

        <div class="form-group">
            <label for="expired_at">Data di scadenza coupon:</label>
            <div style="display: flex">
                <input id="expired_at" type="date" class="form-control" name="expired_at">
                &nbsp;&nbsp;
            </div>

            <div class="form-group">
                <label for="multi_use">multiuso:</label>
                <select name="multi_use">
